...
import com.example.ting.mometest.Activity.RecycleActivity;
import com.example.ting.mometest.Dialog.InfoDialog;
...
public class RecycleManager {
    ...
    public  void recovery(int position){
        ...
        update_bottom(position);
        MsgToast.showToast(mContext,"已恢复");
    }
