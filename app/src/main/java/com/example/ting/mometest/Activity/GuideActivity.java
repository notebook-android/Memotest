...
import com.example.ting.mometest.Adapter.VpAdapter;
...
public class GuideActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    private static  int[] imgs = {R.drawable.details1,R.drawable.details2, R.drawable.details3,R.drawable.details4};
